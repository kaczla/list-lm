...
- [AutoRound](https://github.com/intel/auto-round) - A SOTA quantization algorithm for high-accuracy low-bit LLM inference, seamlessly optimized for CPU/XPU/CUDA, with multi-datatype support and full compatibility with vLLM, SGLang, and Transformers.
...
- [TriAttention](https://github.com/WeianMao/triattention) - KV cache compression using trigonometric frequency-domain analysis for efficient long reasoning, achieving 10.7x memory reduction and 2.5x throughput improvement.
